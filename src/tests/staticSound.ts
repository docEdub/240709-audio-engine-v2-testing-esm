    ...
    await addTests("StaticSound", [
        ...
        },
        {
            ...
            test: async () => {
                ...
                const sound = await createSound(testSoundUrl, { autoplay: true, duration: 2 });
        ...
        },
        {
            ...
            test: async () => {
                await createAudioEngine();
                const sound = await createSound(testSoundUrl, { loop: true, loopStart: 1, loopEnd: 2 });
                sound.play();
        ...
        },
        {
            ...
            test: async () => {
                await createAudioEngine();
                const buffer = await createSoundBuffer(testSoundUrl);
        ...
        },
        {
            ...
            test: async () => {
                await createAudioEngine();
                const sound1 = await createSound(testSoundUrl);
                const sound2 = await createSound(sound1.buffer);
        ...
        },
        {
            ...
            test: async () => {
                ...
                try {
                    await createSound([ac3SoundUrl, mp3SoundUrl], { skipCodecCheck: true, playbackRate: 1.3 });
                } catch (e) {
